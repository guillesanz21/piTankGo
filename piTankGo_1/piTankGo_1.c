 ...
 *  llama a los métodos de inicialización de otros ficheros. Aquí se crean las
 *  máquinas de estados. También se crea la hebra del teclado del PC.
 */
...
/* @Brief		Programa principal. Aquí se crean e inicializan las
 * maquinas de estados.
 */
int main () {
